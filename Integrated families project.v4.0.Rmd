---
title: "Integrated families project.v4.0.rmd"
...
```{r}
#Extract and save Sample table. Use as a template for extracting and saving tables; just change the table names in the code. 
con <- dbConnect(odbc::odbc(), "Histotrac", timeout = 10)
...
```{r}
#Extract and save RelatedPatient table
con <- dbConnect(odbc::odbc(), "Histotrac", timeout = 10)
...
```{r}
#Extract and Save PatientCase table
con <- dbConnect(odbc::odbc(), "Histotrac", timeout = 10)
